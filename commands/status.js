  ...
  request.put(
    {
      ...
      json: true,
      headers: {
        Token: client.config.tokens.api
      }
    },
    function(error, response, body) {
      ...
      if (body.action === 'deactivate')
        return message.channel.send(
          '**TopDesign** | Der Post von **' +
            body.posted_by +
            '** mit der Nummer **#' +
            postid +
            '** wurde erfolgreich deaktiviert. Er hatte **' +
            body.likes +
            ' ' +
            topdesign.voteOrVotes(body.likes) +
            '**.'
        )
      if (body.action === 'activate')
        return message.channel.send(
          '**TopDesign** | Der Post von **' +
            ...
            '** mit der Nummer **#' +
            postid +
            '** wurde erfolgreich aktiviert. Er hatte **' +
            body.likes +
            ' ' +
            topdesign.voteOrVotes(body.likes) +
            '**.'
